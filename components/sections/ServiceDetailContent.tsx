...
const ServiceDetailContent: React.FC<ServiceDetailContentProps> = ({ service }) => {
  return (
    <article className="bg-white p-8 rounded-lg shadow-md">
      ...
      {/* Main Description */}
      <h2 className="text-3xl font-bold text-dark-green mb-4">Why Choose Our Services</h2>
      <p className="text-gray-text leading-relaxed mb-10">{service.longDescription}</p>
      ...
      {/* Work Points */}
      <h3 className="text-2xl font-bold text-dark-green mb-6">Modern Technique Work Points</h3>
      <ul className="space-y-4 mb-12">
        {service.workPoints.map((point, index) => (
